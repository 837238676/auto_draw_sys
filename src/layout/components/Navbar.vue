<template>
  <div class="navbar">
    ...
    <div class="right-menu">
      <el-dropdown class="avatar-container" trigger="click">
        ...
        <el-dropdown-menu slot="dropdown" class="user-dropdown">
          ...
          <router-link to="/task/table">
            <el-dropdown-item> 我的任务 </el-dropdown-item>
          </router-link>
          <el-dropdown-item @click.native="dialogUpdatePw = true">
            修改密码
          </el-dropdown-item>
    ...
    <el-dialog title="修改密码" :visible.sync="dialogUpdatePw">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="dialogUpdatePw = false">取 消</el-button>
  ...
  methods: {
    ...
    updatePw() {
      this.$refs["ruleForm"].validate((valid) => {
        if (valid) {
          if (!this.userForm.name || this.userForm.name.indexOf(" ") != -1) {
            this.$message({
              type: "warning",
              message: "用户名不合法",
            });
